package be.ucll.vansteelandttim.domain.db;
...
public class Database {
    ...
    public Database() {
        ...
        this.gameID = 0;
        add(new Game(this.gameID++,"Deus ex", "Cyberpunk-rpg-shooter", 2));
        add(new Game(this.gameID++,"FTL", "single ship space RTS", 134));
        add(new Game(this.gameID++,"TF2", "class-based shooter", 48));
    }
    ...
    public void add(String name, String genre, int score) {
        this.add(new Game(this.gameID++,name, genre, score));
    }
    ...
    //finds the score of the game by name in the list and returns 9999 if game is not found
    ...
    //returns the game with the highest score
